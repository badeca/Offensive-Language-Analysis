...
sentences = dataset['train']['tweet'][:5]  # SOMENTE AS 10 PRIMEIRAS
...
for original_sentence in sentences:
    ...
    class_comparison = comparison(original_sentence, reform_sentence[0])
...
output_file = 'ajustado_gemini_mistral_v01gptq_output.xlsx'
